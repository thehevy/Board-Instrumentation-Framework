...
# Check for JAR file
$jarPath = "BIFF.Marvin.jar"
if (-not (Test-Path $jarPath)) {
    Write-Host "ERROR: BIFF.Marvin.jar not found in current directory" -ForegroundColor Red
    Write-Host "Expected location: $(Get-Location)\BIFF.Marvin.jar" -ForegroundColor Yellow
    exit 1
}
